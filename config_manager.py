...
def get_hud_style() -> str:
    ...
    about the same. Defaults to the head because that is what @Tecno_techak shipped
...
def get_turn_tuning() -> dict:
    return {
        "enabled": True,
        "silence_ms": 1300,        # কথা বলা থামানোর পর ১.৩ সেকেন্ড অপেক্ষা করবে
        "prefix_ms": 100,
        "end_sensitivity": "low",  # কথার মাঝে একটু থামলে সাথে সাথে কথা কেটে দেবে না
